...
public class xZingUtil {
    ...
    private static int IMAGE_HALFWIDTH = 25;//宽度值，影响中间图片大小
...
//        bitmap.setPixels(pixels,0,100,0,0,w,h);
    ...
    public static Bitmap encodeAsBitmap(String str,int res){
        Bitmap bitmap = createQRCodeWithLogo(str, size,
                BitmapFactory.decodeResource(MyApp.getIns().getResources(), res));
        return bitmap;
    }
    ...
    public static Bitmap createQRCodeWithLogo(String text, Bitmap mBitmap) {
        return createQRCodeWithLogo(text, size, mBitmap);
    }
