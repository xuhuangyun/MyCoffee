...
public class RxAppTool {
    ...
    public static boolean isAppForeground(Context context) {
        ActivityManager manager = MyApp.getIns().getManager(context);
    ...
    public static void InstallAPK(Context context, String APK_PATH) {//提示安装APK
        Intent i = new Intent(Intent.ACTION_VIEW);//用于显示用户的数据。比较通用，会根据用户的数据类型打开相应的Activity
        i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        i.setDataAndType(Uri.parse("file://" + APK_PATH), "application/vnd.android.package-archive");//打开apk文件
