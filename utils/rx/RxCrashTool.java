...
public class RxCrashTool {
    ...
    public static void init(final String crashDir) {
        ...
        try {
            ...
            mCrashDirPath = FilesManage.dri.logs + File.separator + name + File.separator + "crash" + File.separator;
        } catch (Exception e) {
        ...
        //对于那些没有被捕获的异常进行捕获，我们需要做的就是定义一个UncaughtExceptionHandler
        //然后通过setDefaultUncaughtExceptionHandler设置进去就可以
    }
